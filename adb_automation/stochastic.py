...
WAIT_AFTER_HOME_SECONDS = 1.0
WAIT_AFTER_APP_OPEN_SECONDS = 2.5
WAIT_AFTER_APP_CLOSE_SECONDS = 0.8
WAIT_AFTER_SCREEN_OFF_SECONDS = 1.5
WAIT_AFTER_WAKE_SECONDS = 1.0
